...
SELECT
  ...
  'GTFS static WEEKDAY (2024-10-15). Headways 07:00–10:00; per-stop → route median → network median. Attica; GTFS hours ≥24; services filtered by calendar/calendar_dates.'
FROM overall, ids
